...
As it turns out, they've already started working on such a function. Moreover, the function is returning results that don't equal what `dnorm` is returning. *That shouldn't be!* Can you help them figure out where they've gone wrong?
...
You decide to use the example of the conditional probability of pulling out up to 10 red jelly beans in 10 draws *without replacement* from a bowl of 100 total blue and red jelly beans, and you provide the following code to demonstrate the idea more intuitively:
...
Change the code to answer their question...and hope they don't have any more!