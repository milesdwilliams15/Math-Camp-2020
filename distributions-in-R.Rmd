...
You can download the .Rmd file that contains the problem set for this lesson from [here](https://github.com/milesdwilliams15/Math-Camp-2020/blob/master/distributions-in-R-problems.Rmd). You can see the questions in pdf format [here](https://github.com/milesdwilliams15/Math-Camp-2020/blob/master/distributions-in-R-problems.pdf).
